...
var _ = Describe("Sandbox", func() {
	...
	BeforeEach(func() {
		...
		updateImage = imageOf("nginx:stable-alpine3.23")
		initialImage = imageOf("nginx:stable-alpine3.20")
	...
	Context("creation and pending phase", func() {
		...
		It("should create sandbox from templateRef and transition to running phase", func() {
			...
			templateImage := imageOf("nginx:stable-alpine3.23")
